...
The **`Python` code** used to prepare, inspect, and clean the dataset is available for reference at [this link](./Partner_Performance_Insights_Business_Case.ipynb).

The **`SQL` queries** used for data manipulation, along with the detailed step-by-step process for creating and structuring tables in SQL Server Management Studio (SSMS), can be found at [this link](./SQL%20Documentation.md).
...
The **`SQL` queries** used for data manipulation, along with the detailed step-by-step process for creating and structuring tables in SQL Server Management Studio (SSMS), can be found at [this link](./Mid-Month%20Price%20Change%20Automation.md).
